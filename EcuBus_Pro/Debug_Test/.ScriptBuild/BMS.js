...
var msg1 = {
  ...
  msgType: {
    idType: import_ECB2.CAN_ID_TYPE.EXTENDED,
    remote: false,
    canfd: false,
    brs: false
  }
...
var msg3 = {
  id: 67272705,
  // <-- TODO: sostituisci con l'ID reale
  dir: "OUT",
  data: Buffer.from([0, 0, 0, 0, 0, 0, 0, 0]),
  msgType: {
    idType: import_ECB2.CAN_ID_TYPE.EXTENDED,
...
var msg9 = {
  ...
  // <-- TODO: sostituisci con l'ID reale
  dir: "OUT",
  data: Buffer.from([0, 0, 0, 0, 0, 0, 0, 136]),
  msgType: {
    idType: import_ECB2.CAN_ID_TYPE.EXTENDED,
    remote: false,
    canfd: false,
...
var msg12 = {
  ...
  // <-- TODO: sostituisci con l'ID reale
  dir: "OUT",
  data: Buffer.from([0, 0, 0, 0, 0, 0, 0, 221]),
  msgType: {
    idType: import_ECB2.CAN_ID_TYPE.EXTENDED,
    remote: false,
    canfd: false,
...
import_ECB2.Util.Init(async () => {
  console.log("Init: in attesa del messaggio trigger 0x0400FF80");
  import_ECB2.Util.OnCan(67174272, (msg) => {
    resetWatchdog();
    if (started) return;
    started = true;
    ...
    timer200 = setInterval(async () => {
      try {
        await (0, import_ECB2.output)(msg1);
        await (0, import_ECB2.output)(msg2);
        await (0, import_ECB2.output)(msg3);
        msg1.id++;
        msg2.id++;
        msg3.id++;
        await (0, import_ECB2.output)(msg1);
    ...
    timer500 = setInterval(async () => {
      try {
        await (0, import_ECB2.output)(msg13);
        msg13.id++;
        await (0, import_ECB2.output)(msg13);
        msg13.id--;
      } catch (error) {
    ...
    timer1000 = setInterval(async () => {
      try {
        await (0, import_ECB2.output)(msg4);
        await (0, import_ECB2.output)(msg5);
        await (0, import_ECB2.output)(msg6);
        await (0, import_ECB2.output)(msg7);
        await (0, import_ECB2.output)(msg8);
        await (0, import_ECB2.output)(msg9);
        await (0, import_ECB2.output)(msg10);
        await (0, import_ECB2.output)(msg11);
        await (0, import_ECB2.output)(msg12);
        msg4.id++;
        msg5.id++;
        msg6.id++;
        msg7.id++;
