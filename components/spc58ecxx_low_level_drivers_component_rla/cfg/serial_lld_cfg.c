...
/**
 * @brief   Structure defining the SERIAL configuration "configuration_name API mode : SYNCHRONOUS".
 */

 
SerialConfig serial_config_configuration_name = {
  115200,
