...
static spc_mscr_io_init_t spc_mscr_io_init[] = {
  ...
  {(int16_t)MSCR_IO_OutRelPreCha1, (iomode_t)(PAL_SPC5_SSS(0) | PAL_SPC5_OERC(2) | PAL_SPC5_ODC(2) | PAL_SPC5_ILS(0) | PAL_SPC5_WPDE), PAL_LOW},
  {(int16_t)MSCR_IO_PIN_GPIO_stop, (iomode_t)(PAL_SPC5_SSS(0) | PAL_SPC5_OERC(0) | PAL_SPC5_ODC(0) | PAL_SPC5_ILS(0) | PAL_SPC5_IBE | PAL_SPC5_WPDE), PAL_LOW},
  {(int16_t)MSCR_IO_InRelPreCharge, (iomode_t)(PAL_SPC5_SSS(0) | PAL_SPC5_OERC(0) | PAL_SPC5_ODC(0) | PAL_SPC5_SMC | PAL_SPC5_ILS(0) | PAL_SPC5_IBE), PAL_LOW},
  {(int16_t)MSCR_IO_OutRelPreCha2, (iomode_t)(PAL_SPC5_SSS(0) | PAL_SPC5_OERC(2) | PAL_SPC5_ODC(2) | PAL_SPC5_ILS(0) | PAL_SPC5_WPDE), PAL_LOW},
  {(int16_t)MSCR_IO_OutRelPower1, (iomode_t)(PAL_SPC5_SSS(0) | PAL_SPC5_OERC(2) | PAL_SPC5_ODC(2) | PAL_SPC5_ILS(0) | PAL_SPC5_WPDE), PAL_LOW},
  {(int16_t)MSCR_IO_OutRelPower2, (iomode_t)(PAL_SPC5_SSS(0) | PAL_SPC5_OERC(2) | PAL_SPC5_ODC(2) | PAL_SPC5_ILS(0) | PAL_SPC5_WPDE), PAL_LOW},
  ...
  {(int16_t)MSCR_IO_PIN_GPIO_retronebbia, (iomode_t)(PAL_SPC5_SSS(0) | PAL_SPC5_OERC(0) | PAL_SPC5_ODC(0) | PAL_SPC5_ILS(0) | PAL_SPC5_IBE | PAL_SPC5_WPDE), PAL_LOW},
  ...
  {(int16_t)MSCR_IO_InRelPower, (iomode_t)(PAL_SPC5_SSS(0) | PAL_SPC5_OERC(0) | PAL_SPC5_ODC(0) | PAL_SPC5_SMC | PAL_SPC5_ILS(0) | PAL_SPC5_IBE), PAL_LOW},
