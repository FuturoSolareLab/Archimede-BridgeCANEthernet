...
#define PORT_RELE_POW_batt_2        PORT_C
...
#define MSCR_IO_RELE_POW_batt_2     MSCR_IO_INDEX(PORT_RELE_POW_batt_2, RELE_POW_batt_2)
...
#define MSCR_IO_RELE_PRE_batt_1     MSCR_IO_INDEX(PORT_RELE_PRE_batt_1, RELE_PRE_batt_1)
#define MSCR_IO_RELE_POW_batt_1     MSCR_IO_INDEX(PORT_RELE_POW_batt_1, RELE_POW_batt_1)
...
#define MSCR_IO_RELE_PRE_batt_2     MSCR_IO_INDEX(PORT_RELE_PRE_batt_2, RELE_PRE_batt_2)
